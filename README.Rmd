...
```
Also, in `RfPred.Norm` method, normality was
assumed for RF prediction errors, as proposed by Shah *et al.*  
```r
...
predicted probabilities for each missing observation.  
```r
...
For datasets with mixed types of variables, `RfEmp` method is a short cut for
