...
[![GitHub Version Badge](https://img.shields.io/static/v1?label=GitHub&message=2.0.5&color=3399ff)](https://github.com/shangzhi-hong/RfEmpImp)
...
This is the repository for `RfEmpImp`, an R package for multiple imputation
using chained random forests (RF).  
`RfEmpImp` implemented prediction-based and node-based multiple imputation
